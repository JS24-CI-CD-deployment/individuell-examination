  ...
  return (
    <section className="booking">
      ...
      <Shoes
        ...
        shoes={shoes}
      />
      {/* data-testid behövs för att testa att användaren kan slutföra bokningen (User Story 4) */}
      <button className="button booking__button" onClick={book} data-testid="complete-booking-button">
        strIIIIIike!
      </button>
